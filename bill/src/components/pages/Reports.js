...
const Reports = () => {
    ...
    const [invoiceType, setInvoiceType] = useState('All'); // 'All', 'tax', 'labour', or 'invoice'
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
                <div className="p-6 bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
                    <h2 className="text-3xl font-bold mb-2">
                        {invoiceType === 'All' ? 'All' : getTypeDisplayName(invoiceType)} Invoice Reports
                    </h2>
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${typeColors[invoice.invoice_type] || 'bg-gray-100 text-gray-800'}`}>
                                                        {getTypeDisplayName(invoice.invoice_type)}
                                                    </span>
                                                </td>
                                            </motion.tr>
                                        ))
